...
class BithumbCurrencies {
    ...
    var settingCurrencyCount: Int = 0
    var settingCurrencyKey: [String: Int] = [:]

    let currencyNameString: [String] = ["BTC", "ETH", "DASH", "LTC", "ETC", "XRP", "BCH", "XMR", "ZEC", "QTUM", "BTG", "EOS", "ICX", "VET", "TRX", "ELF", "MITH", "MCO", "OMG", "KNC", "GNT", "ZIL", "ETHOS", "PAY", "WAX", "POWR", "LRC", "GTO", "STRAT", "ZRX", "REP", "AE", "XEM", "SNT", "ADA", "PPT", "CTXC", "CMT", "THETA", "WTC", "ITC", "TRUE", "ABT", "RNT", "PLY", "WAVES", "LINK", "ENJ", "PST", "SALT", "RDN", "LOOM", "PIVX", "INS", "BCD", "BZNT", "XLM", "OCN", "BSV", "TMTG", "BAT", "WET", "XVG", "IOST", "POLY", "HC", "ROM", "AMO", "ETZ", "ARN", "APIS", "MTL", "DACC", "DAC", "BHP", "BTT", "HDAC", "NPXS", "AUTO", "GXC", "ORBS", "VALOR", "CON", "ANKR", "MIX"]

    /// starButton 터치상태 확인하는 데 사용하는 딕셔너리 값
    var entireCurrencyKey: [String: Int] = ["BTC": 0, "ETH": 0, "DASH": 0, "LTC": 0, "ETC": 0, "XRP": 0, "BCH": 0, "XMR": 0, "ZEC": 0, "QTUM": 0, "BTG": 0, "EOS": 0, "ICX": 0, "VET": 0, "TRX": 0, "ELF": 0, "MITH": 0, "MCO": 0, "OMG": 0, "KNC": 0, "GNT": 0, "ZIL": 0, "ETHOS": 0, "PAY": 0, "WAX": 0, "POWR": 0, "LRC": 0, "GTO": 0, "STRAT": 0, "ZRX": 0, "REP": 0, "AE": 0, "XEM": 0, "SNT": 0, "ADA": 0, "PPT": 0, "CTXC": 0, "CMT": 0, "THETA": 0, "WTC": 0, "ITC": 0, "TRUE": 0, "ABT": 0, "RNT": 0, "PLY": 0, "WAVES": 0, "LINK": 0, "ENJ": 0, "PST": 0, "SALT": 0, "RDN": 0, "LOOM": 0, "PIVX": 0, "INS": 0, "BCD": 0, "BZNT": 0, "XLM": 0, "OCN": 0, "BSV": 0, "TMTG": 0, "BAT": 0, "WET": 0, "XVG": 0, "IOST": 0, "POLY": 0, "HC": 0, "ROM": 0, "AMO": 0, "ETZ": 0, "ARN": 0, "APIS": 0, "MTL": 0, "DACC": 0, "DAC": 0, "BHP": 0, "BTT": 0, "HDAC": 0, "NPXS": 0, "AUTO": 0, "GXC": 0, "ORBS": 0, "VALOR": 0, "CON": 0, "ANKR": 0, "MIX": 0]

    init() {
        self.setCurrencyData()
    }

    func refreshSettingCurrencyKey() {
        self.settingCurrencyKey = self.entireCurrencyKey
    }

    func setBithumbCurrenyKey(key: String) {
        if self.entireCurrencyKey[key] == 0 {
            self.settingCurrencyCount += 1
            self.entireCurrencyKey[key] = 1 // starButton 터치상태 확인하는 데 사용하는 딕셔너리 값
            self.settingCurrencyKey[key] = self.settingCurrencyCount
        } else {
            self.settingCurrencyCount -= 1
            self.entireCurrencyKey[key] = 0
            self.settingCurrencyKey.removeValue(forKey: key)
        }
        self.saveCurrencyData()
    }

    func setCurrencyData() {
        guard let settingCurrencyKeyData = UserDefaults.standard.dictionary(forKey: DataIdentifier.bithumbSettingCurrencyKey) as? [String: Int],
            let currencyKeyData = UserDefaults.standard.dictionary(forKey: DataIdentifier.bithumbCurrencyKey) as? [String: Int] else { return }
        self.settingCurrencyKey = settingCurrencyKeyData
        self.entireCurrencyKey = currencyKeyData
    }

    func saveCurrencyData() {
        UserDefaults.standard.set(self.settingCurrencyKey, forKey: DataIdentifier.bithumbSettingCurrencyKey)
        UserDefaults.standard.set(self.entireCurrencyKey, forKey: DataIdentifier.bithumbCurrencyKey)
    }
}
